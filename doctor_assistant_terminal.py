...
problem tanimi: kullanicinin saglikla ilgili sorularini anlayan ve yanitlayan bir GPT tabanli doktor asistani chatbot
    ...
    - mesaj gecmisini hatirlayarak diyalogu ona gore surdurmeli "memory"
...
install libraries
    ...
    - langchain: llm, memory, chain yapisi icin kullanacagimiz kutuphane
    - openai: openai api ile iletisim kurmak icin kullanacagimiz kutuphane
